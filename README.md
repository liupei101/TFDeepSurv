...
**NOTE:** [tfdeepsurv-v2.0.0](https://github.com/liupei101/TFDeepSurv/releases) has been released. The Old version is on branch `archive_v1`. Compared with `v1.0`, current refactored version  largely improved:
